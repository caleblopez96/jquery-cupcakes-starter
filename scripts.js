...
$.get(
    ...
    // clear out contitaner
    $("#cupcakes").empty().append("<div> There was an error in your request. Please try again.</div>");
});
...
$("#filter").change(function () {
    ...
    if (tag === "all") {
        ...
        let filteredCupcakes = cupcakesCollection.filter((a) => a.tags.includes(tag));
